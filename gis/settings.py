...
MIDDLEWARE = [
    ...
    "myapp.middleware.FriendlyErrorPagesMiddleware",
...
CKEDITOR_CONFIGS = {
    "apartment_desc": {
        ...
        "width": "auto",
        "toolbar": [
            ["Format", "FontSize", "Bold", "Italic", "Underline", "Strike", "RemoveFormat"],
            ["TextColor", "BGColor"],
        ...
        "extraPlugins": ",".join(["uploadimage", "image2", "justify", "colorbutton"]),
