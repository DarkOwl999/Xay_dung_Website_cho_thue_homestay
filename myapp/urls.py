...
urlpatterns = [
    ...
    path('quen-mat-khau/dat-lai/', views.forgot_password_reset, name='forgot_password_reset'),
    path(
        'login/',
    ...
    path('quan-ly/danh-gia/sua/<int:id>/', views.review_update, name='review_update'),
